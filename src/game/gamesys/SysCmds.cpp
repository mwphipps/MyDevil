...
#endif
// MyDevil Added ( Silly Rabbit Classes )
    cmdSystem->AddCommand( "changeClass",           idMultiplayerGame::ChangeClassRequest_f, CMD_FL_GAME,   "change your class, effective on next spawn." ); 
    cmdSystem->AddCommand( "startClassMenu",        idMultiplayerGame::StartClassMenu_f,	CMD_FL_GAME,    "pop's up a gui menu from which you can select a classto spawn as." ); 
