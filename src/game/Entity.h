...
public:
  ...
  // Nicemice: FIXME: removed 'const'
	void					ServerSendEvent( int eventId, const idBitMsg *msg, bool saveEvent, int excludeClient );
  ...
  virtual bool NetworkSyncTarget() const;
  void DynamicNetworkSync( const char* reason = "dynamic" );
