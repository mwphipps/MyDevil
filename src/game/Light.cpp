...
void idLight::Spawn( void ) {
    ...
    if ( fl.networkSync == false && !isMapEntity ) {
      //fl.networkSync = true;
...
void idLight::Event_SetLightParm( int parmnum, float value ) {
  // Nicemice: TEST DYNAMIC
  DynamicNetworkSync( "setLightParm" );
...
void idLight::Event_SetLightParms( float parm0, float parm1, float parm2, float parm3 ) {
  // Nicemice: TEST DYNAMIC
  DynamicNetworkSync( "setLightParms" );
...
void idLight::Event_ToggleOnOff( idEntity *activator ) {
  // Nicemice: TEST DYNAMIC
  DynamicNetworkSync( "toggleOnOff" );
	triggercount++;
...
/*
================
idLight::Event_FadeOut - Nicemice: modified
================
*/
void idLight::Event_FadeOut( float time ) {

  // Nicemice: TEST DYNAMIC
  DynamicNetworkSync( "fadeOutLight" );
...
/*
================
idLight::Event_FadeIn - Nicemice: modified
================
*/
void idLight::Event_FadeIn( float time ) {

  // Nicemice: TEST DYNAMIC
  DynamicNetworkSync( "fadeInLight" );
...
/*
================
idLight::NetworkSyncTarget - Nicemice: added
================
*/
bool idLight::NetworkSyncTarget() const {
  return true;
};
