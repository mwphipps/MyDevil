...
void idAFEntity_Gibbable::Gib( const idVec3 &dir, const char *damageDefName ) {
	...
	if ( g_bloodEffects.GetBool() ) {
      ...
      // Nicemice: FIXME: we have to change the shadow state on the client too
			renderEntity.noShadow = true;
			//renderEntity.shaderParms[ SHADERPARM_TIME_OF_DEATH ] = gameLocal.time * 0.001f;
			//StartSound( "snd_gibbed", SND_CHANNEL_ANY, 0, false, NULL );
      ProcessEvent( &EV_SetShaderParm, SHADERPARM_TIME_OF_DEATH, gameLocal.time * 0.001f );
      StartSound( "snd_gibbed", SND_CHANNEL_ANY, 0, true, NULL );
		}
  }
  gibbed = true;
...
================
*/
void idAFEntity_Generic::WriteToSnapshot(idBitMsgDelta &msg) const {
...
/*
================
idAFEntity_WithAttachedHead::ReadFromSnapshot - Nicemice: added
================
*/
void idAFEntity_WithAttachedHead::WriteToSnapshot( idBitMsgDelta &msg ) const {
  WriteHiddenToSnapshot( msg );
  GetPhysics()->WriteToSnapshot( msg );
}
...
================
*/
void idAFEntity_WithAttachedHead::ReadFromSnapshot( const idBitMsgDelta& msg ) {
  ReadHiddenFromSnapshot( msg );
  GetPhysics()->ReadFromSnapshot( msg );
}
...
/*
================
idAFEntity_WithAttachedHead::ClientPredictionThink - Nicemice: added
================
*/
void idAFEntity_WithAttachedHead::ClientPredictionThink( void ) {
  Think();
}
