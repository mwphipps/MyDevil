...
/*
================
idItem::Spawn - modified by Nicmice
================
*/
...
/*
================
idVideoCDItem::GiveToPlayer - Nicemice: modified
================
*/
bool idVideoCDItem::GiveToPlayer( idPlayer *player ) {

  Event_GiveVideoCD( player );
...
/*
================
idVideoCDItem::ClientReceiveEvent - Nicemice: added
================
*/
bool idVideoCDItem::ClientReceiveEvent( int event, int time, const idBitMsg &msg ) {

  switch ( event ) {
    case EVENT_GIVEVIDEOCD: {
		  int spawnId = msg.ReadBits( 32 );
		  idEntityPtr< idPlayer > entPtr;
		  if( !entPtr.SetSpawnId( spawnId ) ) {
			  break;
		  }
      Event_GiveVideoCD( entPtr.GetEntity() );
      return true;
      }
  }
  return idItem::ClientReceiveEvent( event, time, msg );
...
/*
================
idVideoCDItem::Event_GiveVideoCD - Nicemice: added
================
*/
void idVideoCDItem::Event_GiveVideoCD( idPlayer *player ) {
  ...
  if ( gameLocal.isServer ) {
    ...
    ServerSendEvent( EVENT_GIVEVIDEOCD , &msg, false, -1 );
  }
