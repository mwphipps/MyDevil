...
void idActor::SetupHead( void ) {
    ...
    if ( isMapEntity ) {
      ...
      // Nicemice: If our actor is a temporary entity, so we have to spawn the head over the network
...
void idActor::Event_EnableEyeFocus( void ) {
  ...
  //  gameLocal.Printf("coop: idActor::Event_EnableEyeFocus: %s(%s) unhandled\n",GetType()->classname,name.c_str());
  //}
	allowEyeFocus = true;
	blink_time = gameLocal.time + blink_min + gameLocal.random.RandomFloat() * ( blink_max - blink_min );
}
...
void idActor::Event_DisableEyeFocus( void ) {
  ...
  // Nicemice: DEBUG
  //if ( isServerSyncronised ) {
  //  gameLocal.Printf("coop: idActor::Event_DisableEyeFocus: %s(%s) unhandled\n",GetType()->classname,name.c_str());
  //}
...
void idActor::Event_DisableWalkIK( void ) {
  ...
  // Nicemice: DEBUG
  //if ( isServerSyncronised ) {
  //  gameLocal.Printf("coop: idActor::Event_DisableWalkIK: %s(%s) unhandled\n",GetType()->classname,name.c_str());
  // }
...
void idActor::Event_EnableLegIK( int num ) {
  // Nicemice: DEBUG
  //if ( isServerSyncronised )
  //  gameLocal.Printf("coop: idActor::Event_EnableLegIK: %s(%s) unhandled\n",GetType()->classname,name.c_str());
...
void idActor::Event_DisableLegIK( int num ) {
  // Nicemice: DEBUG
  //if ( isServerSyncronised ) {
  //  gameLocal.Printf("coop: idActor::Event_DisableLegIK: %s(%s) unhandled\n",GetType()->classname,name.c_str());
  // }
